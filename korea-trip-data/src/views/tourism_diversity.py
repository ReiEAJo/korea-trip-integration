...
def render_tourism_diversity():
    ...
    try:
        ...
        with col1:
            ...
            fig1.update_layout(
                ...
                xaxis=dict(showgrid=False, zeroline=False, linecolor="#CBD5E1", type="category"),
                yaxis=dict(showgrid=True, gridcolor="#E2E8F0", zeroline=False, linecolor="#CBD5E1")
            )
            st.plotly_chart(fig1, use_container_width=True, key='chart_tourism_diversity_fig1_17')
        ...
        with col2:
            ...
            fig2.update_traces(textinfo='label+percent entry', textfont_size=14, marker=dict(line=dict(color='#FFFFFF', width=2)))
            fig2.update_layout(
                plot_bgcolor="rgba(0,0,0,0)",
                paper_bgcolor="rgba(0,0,0,0)",
                font=dict(family="Pretendard, sans-serif", size=14, color="#E2E8F0"),
            ...
            st.plotly_chart(fig2, use_container_width=True, key='chart_tourism_diversity_fig2_18')
    ...
    try:
        ...
        with st.container():
            ...
            with col_sp1:
                ...
                fig_pie_spend.update_layout(
                    ...
                    xaxis=dict(showgrid=True, gridcolor="#E2E8F0", zeroline=True, zerolinecolor="#475569", linecolor="#CBD5E1"),
                    yaxis=dict(showgrid=False, zeroline=False, linecolor="#CBD5E1"),
                    yaxis_title=None
                )
                st.plotly_chart(fig_pie_spend, use_container_width=True, key='chart_tourism_diversity_fig_pie_spend_19')
            ...
            with col_sp2:
                ...
                fig_city_spend.update_layout(
                    ...
                    hoverlabel=dict(bgcolor="#E2E8F0", font_size=13, font_family="Pretendard", font=dict(color="#F8FAFC")),
                    margin=dict(l=20, r=20, t=20, b=20),
                    xaxis=dict(title="관광지출액(억원)", tickformat=",.0f", showgrid=True, gridcolor="#E2E8F0", zeroline=False, linecolor="#CBD5E1"),
                    yaxis_title=None
                )
                st.plotly_chart(fig_city_spend, use_container_width=True, key='chart_tourism_diversity_fig_city_spend_20')
        ...
        fig_scatter.update_layout(
            ...
            hoverlabel=dict(bgcolor="#E2E8F0", font_size=13, font_family="Pretendard", font=dict(color="#F8FAFC")),
            margin=dict(l=20, r=20, t=40, b=20),
            xaxis=dict(tickformat=",.0f", showgrid=True, gridcolor="#E2E8F0", zeroline=False, linecolor="#CBD5E1"),
            yaxis=dict(tickformat=",.0f", showgrid=True, gridcolor="#E2E8F0", zeroline=False, linecolor="#CBD5E1"),
            coloraxis_colorbar=dict(tickformat=",.0f")
        )
        st.plotly_chart(fig_scatter, use_container_width=True, key='chart_tourism_diversity_fig_scatter_21')
