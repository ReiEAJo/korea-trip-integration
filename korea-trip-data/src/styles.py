"""
Streamlit 애플리케이션의 시각적 가독성 및 UI 디자인을 향상시키기 위한 공통 CSS 스타일을 정의하는 모듈입니다 (고급 라이트 모드 테마).
"""
...
def apply_custom_style():
    """
    Streamlit 앱에 커스텀 CSS 스타일을 적용합니다 (고급 라이트 모드 테마).
    """
    style = """
    ...
    <style>
        ...
        /* Metric (지표 카드) 가독성 및 호버 모션 향상 - 라이트 테마 적용 */
        ...
        [data-testid="stMetric"]:hover {
            ...
            box-shadow: 0 10px 15px -3px rgba(29, 78, 216, 0.08), 0 4px 6px -2px rgba(29, 78, 216, 0.04) !important;
