...
/* 1. Remove overflow clipping so STICKY works */
/* We DO NOT touch transform or stAppViewMain to preserve scroll! */
.block-container,
...
/* 2. STICKY positioning (Sticks within the scrolling viewport) */
...
/* Tabs Top set to 65px for a 10px font-like gap from the title */
