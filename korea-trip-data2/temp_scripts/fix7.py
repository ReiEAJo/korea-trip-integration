...
/* 1. Disable all CSS transforms that break fixed positioning */
.stAppViewMain, 
.block-container, 
...
/* 2. Add padding so content is not hidden behind fixed headers */
div.block-container {
...
/* Selected state: Semi-transparent white with NORMAL black text */
